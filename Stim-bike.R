...
voluntary_activation_relative <- ggplot(
      ...
      theme_pubr(legend = "none") +
      theme(text = element_text(size=20)) +
      labs(y = 'Voluntary activation [%] relative to Pre value', x = '') + 
...
potentiated_twitch_norm_common <- ggplot(
      ...
      theme_pubr(legend = "none") +
      theme(text = element_text(size=20)) +
      labs(y = 'Potentiated twitch force [%] normalized to Pre value', x = '') + 
      geom_vline(xintercept = 4.5, linetype = "dashed") +
      scale_x_discrete(guide = guide_axis(n.dodge = 2)) + 
      scale_color_manual(values = c("#009E73","#D55E00", "#56B4E9","#E69F00")) +
      guides(x = guide_axis_truncated(trunc_upper = 4.5, trunc_lower = 0.4))
...
tw_baseline <- ggplot(
      ...
      stat_compare_means(method = "wilcox", label = "p.signif",
                         ...
                         method.args = list(var.equal = TRUE, p.adjust.method = "bonferroni")) +
      theme_pubr(legend = "none") + 
      labs(y = 'Potentiated Twitch force normalized to bodyweight [N/kg]', x = '') + 
      theme(text = element_text(size=20)) +
...
itt_common <- ggplot(
      ...
      theme_pubr(legend = "none") +
      theme(text = element_text(size = 20)) +
      labs(y = 'Maximal voluntary force  [%] normalized to Pre value', x = '') + 
      geom_vline(xintercept = 4.5, linetype = "dashed") +
      scale_color_manual(values = c("#009E73","#D55E00", "#56B4E9","#E69F00")) +
      scale_x_discrete(guide = guide_axis(n.dodge = 2)) + 
      guides(x = guide_axis_truncated(trunc_upper = 4.5, trunc_lower = 0.4))
...
mvc_baseline <- ggplot(
      ...
      theme_pubr(legend = "none") +
      theme(text = element_text(size=20)) +
      labs(y = 'MVC force normalized to bodyweight [N/kg]', x = '') + 
